...
import { Activity, Globe, Zap, AlertTriangle, ChevronDown, CheckCircle, Clock, Map, Layers } from 'lucide-react';
      ...
      <div className="flex items-center space-x-3 lg:space-x-5 min-w-0">
        ...
        <div className="flex space-x-1 rounded-lg bg-zinc-900/50 p-1 border border-white/5">
          ...
          <button
            ...
            className={`rounded px-3 py-1.5 transition-all ${
              mode === 'analysis' ? 'bg-purple-600/20 text-purple-400 border border-purple-500/30' : 'hover:bg-zinc-800'
            }`}
          >
            Analysis Mode
          </button>
